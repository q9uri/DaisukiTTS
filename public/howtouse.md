...
設定でテキストファイルも一緒に書き出すこともできます。ファイル名は「設定」→「オプション」→「書き出しファイル名パターン」で変更できます。
...
「ファイル」→「テキストをつなげて書き出し」ボタンで、エディタ上のすべてのテキストを書き出せます。  
